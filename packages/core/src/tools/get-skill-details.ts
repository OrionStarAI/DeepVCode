...
Use \`list_available_skills\` to see all available skills.`,
      ...
      const lines: string[] = [
        ...
        '   ```',
        `   read_file("${skill.skillMdPath}")`,
        '   ```',
        '',
        '2. **Follow the instructions** in skill.md to understand:',
        '   - What scripts are available',
        '   - How to execute them',
        '   - What parameters they require',
        '',
        '3. **Execute the scripts** using `run_shell_command`:',
        '   - Use the exact commands specified in skill.md',
        '   - Do NOT write your own implementation',
        '   - Do NOT use alternative libraries',
        '',
        '## Important Reminders',
        '- ✅ Always read skill.md before using the skill',
        '- ✅ Use the provided scripts exactly as documented',
        '- ✅ Follow the workflow described in skill.md',
