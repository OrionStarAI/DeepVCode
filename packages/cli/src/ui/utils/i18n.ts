...
export const translations = {
  en: {
    ...
    'skill.marketplace.list.title': 'Found {count} marketplace(s):\n',
    'skill.marketplace.add.adding': 'Adding marketplace from {location}...',
    'skill.marketplace.add.success': '✅ Successfully added: {name}\n   ID: {id}\n   Plugins: {count}',
    'skill.marketplace.add.error.missing': 'Error: Missing marketplace location',
    'skill.marketplace.add.usage': 'Usage: /skill marketplace add <url|path> [--name <name>]',
    'skill.marketplace.update.updating': 'Updating marketplace {id}...',
    'skill.marketplace.update.success': '✅ Successfully updated: {name}\n   Plugins: {count}',
    'skill.marketplace.update.error.missing': 'Error: Missing marketplace name',
    'skill.marketplace.update.usage': 'Usage: /skill marketplace update <name>',
    'skill.marketplace.remove.success': '✅ Successfully removed: {id}',
    'skill.marketplace.remove.deleted': '\n   Files deleted from disk',
    'skill.marketplace.remove.error.missing': 'Error: Missing marketplace name',
    'skill.marketplace.remove.usage': 'Usage: /skill marketplace remove <name> [--delete-files]',
    'skill.marketplace.browse.empty': 'No plugins found in {id}',
    'skill.marketplace.browse.empty.query': ' (query: "{query}")',
    'skill.marketplace.browse.title': 'Found {count} plugin(s) in {id}:\n',
    'skill.marketplace.browse.error.missing': 'Error: Missing marketplace name',
    'skill.marketplace.browse.usage': 'Usage: /skill marketplace browse <name> [query]',

    'skill.plugin.list.empty': 'No plugins installed.',
    'skill.plugin.list.empty.hint': 'Install one:\n  /skill plugin install <marketplace> <plugin-name>',
    'skill.plugin.list.installed.title': 'Installed plugins ({count}):\n',
    'skill.plugin.list.available.title': 'Available plugins in {id}:\n',
    'skill.plugin.list.empty.marketplace': 'No plugins found in {id}',
    'skill.plugin.install.installing': 'Installing plugin {name} from {marketplace}...',
    'skill.plugin.install.success': '✅ Successfully installed: {name}\n   ID: {id}\n   Skills: {count}\n   Status: Enabled',
    'skill.plugin.install.error.missing': 'Error: Both marketplace and plugin name required',
    ...
    'skill.plugin.uninstall.deleted': '\n   Files deleted from disk',
    'skill.plugin.uninstall.error.missing': 'Error: Missing plugin ID',
    'skill.plugin.uninstall.usage': 'Usage: /skill plugin uninstall <plugin-id> [--delete-files]',
    'skill.plugin.enable.success': '✅ Successfully enabled: {id}\n\nSkills from this plugin are now available.',
    'skill.plugin.enable.error.missing': 'Error: Missing plugin ID',
    ...
    'skill.plugin.disable.error.missing': 'Error: Missing plugin ID',
    'skill.plugin.disable.usage': 'Usage: /skill plugin disable <plugin-id>',
    'skill.plugin.info.not.installed': 'Plugin {id} is not installed.',
    'skill.plugin.info.error.missing': 'Error: Missing plugin ID',
    'skill.plugin.info.usage': 'Usage: /skill plugin info <plugin-id>',
    'skill.plugin.status.enabled': '✅ Enabled',
    'skill.plugin.status.disabled': '❌ Disabled',

    'skill.list.empty': 'No skills found.',
    'skill.list.empty.hint': 'Install a plugin:\n  /skill plugin list',
    'skill.list.title': 'Available skills ({count}):\n',
    'skill.info.not.found': 'Skill {id} not found.',
    'skill.info.not.found.hint': 'List all skills:\n  /skill list',
    'skill.info.error.missing': 'Error: Missing skill ID',
    'skill.info.usage': 'Usage: /skill info <skill-id>',
    'skill.info.metadata': 'Metadata:',
    'skill.info.marketplace': '  Marketplace: {id}',
    'skill.info.plugin': '  Plugin: {id}',
    'skill.info.license': '  License: {license}',
    'skill.info.allowed.tools': '  Allowed Tools: {tools}',
    'skill.info.dependencies': '  Dependencies: {deps}',
    'skill.info.instructions': 'Instructions:',
    'skill.info.scripts': 'Scripts:',
    'skill.info.references': 'Reference Documents:',

    'skill.stats.title': 'Skills Statistics:\n',
    'skill.stats.total': 'Total Skills: {count}',
    'skill.stats.by.marketplace': 'By Marketplace:',
    'skill.stats.by.plugin': 'By Plugin:',

    'skill.common.error.prefix': 'Failed to {action}: {error}',
    'skill.common.installed': '✅ Yes',
    'skill.common.not.installed': '❌ No',
  },
  zh: {
    // Update flow
    ...
    'skill.marketplace.list.title': '找到 {count} 个 Marketplace：\n',
    'skill.marketplace.add.adding': '正在从 {location} 添加 Marketplace...',
    'skill.marketplace.add.success': '✅ 成功添加：{name}\n   ID：{id}\n   Plugins：{count}',
    'skill.marketplace.add.error.missing': '错误：缺少 Marketplace 位置',
    'skill.marketplace.add.usage': '用法：/skill marketplace add <url|path> [--name <name>]',
    'skill.marketplace.update.updating': '正在更新 Marketplace {id}...',
    'skill.marketplace.update.success': '✅ 成功更新：{name}\n   Plugins：{count}',
    'skill.marketplace.update.error.missing': '错误：缺少 Marketplace 名称',
    'skill.marketplace.update.usage': '用法：/skill marketplace update <name>',
    'skill.marketplace.remove.success': '✅ 成功删除：{id}',
    'skill.marketplace.remove.deleted': '\n   文件已从磁盘删除',
    'skill.marketplace.remove.error.missing': '错误：缺少 Marketplace 名称',
    'skill.marketplace.remove.usage': '用法：/skill marketplace remove <name> [--delete-files]',
    'skill.marketplace.browse.empty': '在 {id} 中未找到 Plugin',
    'skill.marketplace.browse.empty.query': ' (查询："{query}")',
    'skill.marketplace.browse.title': '在 {id} 中找到 {count} 个 Plugin：\n',
    'skill.marketplace.browse.error.missing': '错误：缺少 Marketplace 名称',
    'skill.marketplace.browse.usage': '用法：/skill marketplace browse <name> [query]',

    'skill.plugin.list.empty': '未安装任何 Plugin。',
    'skill.plugin.list.empty.hint': '安装一个：\n  /skill plugin install <marketplace> <plugin-name>',
    'skill.plugin.list.installed.title': '已安装的 Plugins ({count})：\n',
    'skill.plugin.list.available.title': '{id} 中可用的 Plugins：\n',
    'skill.plugin.list.empty.marketplace': '在 {id} 中未找到 Plugin',
    'skill.plugin.install.installing': '正在从 {marketplace} 安装 Plugin {name}...',
    'skill.plugin.install.success': '✅ 成功安装：{name}\n   ID：{id}\n   Skills：{count}\n   状态：已启用',
    'skill.plugin.install.error.missing': '错误：需要同时提供 Marketplace 和 Plugin 名称',
    'skill.plugin.install.usage': '用法：/skill plugin install <marketplace> <plugin-name>',
    'skill.plugin.uninstall.success': '✅ 成功卸载：{id}',
    'skill.plugin.uninstall.deleted': '\n   文件已从磁盘删除',
    'skill.plugin.uninstall.error.missing': '错误：缺少 Plugin ID',
    'skill.plugin.uninstall.usage': '用法：/skill plugin uninstall <plugin-id> [--delete-files]',
    'skill.plugin.enable.success': '✅ 成功启用：{id}\n\n该 Plugin 的 Skills 现已可用。',
    'skill.plugin.enable.error.missing': '错误：缺少 Plugin ID',
    'skill.plugin.enable.usage': '用法：/skill plugin enable <plugin-id>',
    'skill.plugin.disable.success': '✅ 成功禁用：{id}\n\n该 Plugin 的 Skills 已不可用。',
    'skill.plugin.disable.error.missing': '错误：缺少 Plugin ID',
    'skill.plugin.disable.usage': '用法：/skill plugin disable <plugin-id>',
    'skill.plugin.info.not.installed': 'Plugin {id} 未安装。',
    'skill.plugin.info.error.missing': '错误：缺少 Plugin ID',
    'skill.plugin.info.usage': '用法：/skill plugin info <plugin-id>',
    'skill.plugin.status.enabled': '✅ 已启用',
    'skill.plugin.status.disabled': '❌ 已禁用',

    'skill.list.empty': '未找到 Skill。',
    'skill.list.empty.hint': '安装一个 Plugin：\n  /skill plugin list',
    'skill.list.title': '可用的 Skills ({count})：\n',
    'skill.info.not.found': '未找到 Skill {id}。',
    'skill.info.not.found.hint': '列出所有 Skills：\n  /skill list',
    'skill.info.error.missing': '错误：缺少 Skill ID',
    'skill.info.usage': '用法：/skill info <skill-id>',
    'skill.info.metadata': '元数据：',
    'skill.info.marketplace': '  Marketplace：{id}',
    'skill.info.plugin': '  Plugin：{id}',
    'skill.info.license': '  许可证：{license}',
    'skill.info.allowed.tools': '  允许的工具：{tools}',
    'skill.info.dependencies': '  依赖项：{deps}',
    'skill.info.instructions': '指令：',
    'skill.info.scripts': '脚本：',
    'skill.info.references': '参考文档：',

    'skill.stats.title': 'Skills 统计信息：\n',
    'skill.stats.total': 'Skills 总数：{count}',
    'skill.stats.by.marketplace': '按 Marketplace：',
    'skill.stats.by.plugin': '按 Plugin：',

    'skill.common.error.prefix': '{action}失败：{error}',
    'skill.common.installed': '✅ 是',
    'skill.common.not.installed': '❌ 否',
  },
};
