...
export const translations = {
  en: {
    ...
    'config.option.agent.style.default': '🧠 Default (Plan & explain)',
    'config.option.agent.style.codex': '⚡ Codex (Fast & silent)',
    'config.option.agent.style.cursor': '🎯 Cursor (Semantic search)',
  ...
  zh: {
    ...
    'config.option.agent.style.default': '🧠 默认 (计划与解释)',
    'config.option.agent.style.codex': '⚡ Codex (快速且静默)',
    'config.option.agent.style.cursor': '🎯 Cursor (语义搜索)',
